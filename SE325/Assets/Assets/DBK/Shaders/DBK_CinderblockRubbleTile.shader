...
Shader "DBK/CinderblockRubbleTile"
{
	Properties
	{
		...
		_ColorsNumber("ColorsNumber", Vector) = (0,-0.08,0,0)
		...
		_DBK_Brick_Rubble_Tile_NM("DBK_Brick_Rubble_Tile_NM", 2D) = "bump" {}
	...
	SubShader
	{
		...
		uniform sampler2D _DBK_Brick_Rubble_Tile_NM;
		uniform float4 _DBK_Brick_Rubble_Tile_NM_ST;
		uniform float _DetailsNMScale;
		uniform sampler2D _DetailsNM;
		uniform sampler2D _MainTex;
		uniform half2 _ColorsNumber;
		uniform int _Color;
		...
		{
			float2 uv_MainTex1 = v.texcoord * _MainTex1_ST.xy + _MainTex1_ST.zw;
			float4 tex2DNode133 = tex2Dlod( _MainTex1, float4( uv_MainTex1, 0, 0.0) );
			...
			float2 uv_TexCoord89 = v.texcoord.xy * temp_cast_1;
		...
		{
			float2 uv_DBK_Brick_Rubble_Tile_NM = i.uv_texcoord * _DBK_Brick_Rubble_Tile_NM_ST.xy + _DBK_Brick_Rubble_Tile_NM_ST.zw;
			float2 temp_cast_0 = (_DetailsTiling).xx;
			float2 uv_TexCoord89 = i.uv_texcoord * temp_cast_0;
			float2 TilingAmount91 = uv_TexCoord89;
			float3 Normals94 = BlendNormals( UnpackScaleNormal( tex2D( _DBK_Brick_Rubble_Tile_NM, uv_DBK_Brick_Rubble_Tile_NM ), _BakedNMScale ) , UnpackScaleNormal( tex2D( _DetailsNM, TilingAmount91 ), _DetailsNMScale ) );
			o.Normal = Normals94;
			...
			float2 uv4_TexCoord80 = i.uv4_texcoord4 * _ColorsNumber + appendResult79;
			float4 Color383 = tex2D( _MainTex, uv4_TexCoord80 );
			float2 uv_MainTex1 = i.uv_texcoord * _MainTex1_ST.xy + _MainTex1_ST.zw;
			float4 tex2DNode133 = tex2D( _MainTex1, uv_MainTex1 );
			float Mask_A_Red134 = tex2DNode133.r;
			float2 uv4_TexCoord77 = i.uv4_texcoord4 * _ColorsNumber + temp_output_74_0;
			float4 Color1UV381 = tex2D( _MainTex, uv4_TexCoord77 );
			...
			float2 uv4_TexCoord85 = i.uv4_texcoord4 * _ColorsNumber + appendResult87;
			float4 Color2UV386 = tex2D( _MainTex, uv4_TexCoord85 );
...
/*ASEBEGIN
Version=18100
1920;77;1680;998;3986.625;3345.373;6.457853;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;90;-2248.326,892.4756;Inherit;False;Property;_DetailsTiling;Details Tiling;12;0;Create;True;0;0;False;0;False;0;5;1;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;70;-1516.417,-1061.846;Inherit;False;Property;_Color;Color;9;1;[PerRendererData];Create;False;0;0;False;0;False;0;0;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;71;-1533.295,-906.8967;Inherit;False;Property;_CustomColor;Custom Color;23;0;Create;True;0;0;False;0;False;0;24;0;1;INT;0
Node;AmplifyShaderEditor.StaticSwitch;72;-1313.295,-942.8968;Inherit;False;Property;_UseCustomColor;Use Custom Color;22;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;73;-1314.66,-1236.519;Half;False;Constant;_NumberOfColors;NumberOfColors;21;0;Create;True;0;0;False;1;;False;0.015625,0;0.125,0.73;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;55;-1689.782,842.0186;Inherit;True;Property;_MaskB;Mask B;14;0;Create;True;0;0;False;0;False;-1;5b71a3cf759201643b7d66aa9084dbd4;5b71a3cf759201643b7d66aa9084dbd4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;133;-906.0053,829.848;Inherit;True;Property;_MainTex1;Mask A;13;0;Create;False;0;0;False;0;False;-1;42e76383800765b4883fbf88468d3d60;42e76383800765b4883fbf88468d3d60;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DynamicAppendNode;79;-784.8315,-632.8185;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0.1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;75;-867.5462,-1281.693;Half;False;Property;_ColorsNumber;ColorsNumber;20;0;Create;True;0;0;False;1;;False;0,-0.08;0.015625,-0.056;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;80;-490.1853,-669.6181;Inherit;False;3;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.1,0.1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-760.0119,1899.403;Inherit;False;Property;_PaintRange;Paint Range;7;0;Create;True;0;0;False;0;False;0;0.64755;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;76;-512.2083,-1111.84;Inherit;True;Property;_MainTex;Color Theme;6;0;Create;False;0;0;False;0;False;fb0e05ef0dc56c643af47507dafa28c9;fb0e05ef0dc56c643af47507dafa28c9;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.GetLocalVarNode;178;690.9976,2276.664;Inherit;False;56;Mask_B_Red;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;85;-492.2032,-852.1651;Inherit;False;3;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.1,0.1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;46;2277.391,1679.693;Inherit;False;Property;_DirtRange;Dirt Range;16;0;Create;True;0;0;False;0;False;0;0.213007;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-760.1808,1995.766;Inherit;False;Property;_PaintSmooth;Paint Smooth;8;0;Create;True;0;0;False;0;False;0;0.06668227;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;47;2261.39,1743.693;Inherit;False;Property;_DirtSmooth;Dirt Smooth;15;0;Create;True;0;0;False;1;MaxGay;False;0;0.8348978;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;77;-512.7734,-1259.538;Inherit;False;3;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.1,0.1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;213;959.1013,2295.32;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;2725.391,1695.693;Inherit;False;Property;_DirtContrast;Dirt Contrast;17;0;Create;True;0;0;False;0;False;0;1.010981;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;179;698.8609,2416.128;Inherit;False;194;VertexBlue;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;183;827.8595,2592.128;Inherit;False;Property;_CutAlphaRange;Cut Alpha Range;27;0;Create;True;0;0;False;0;False;0;0.07344181;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;48;2693.391,1471.694;Inherit;False;Color Mask;-1;;46;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;182;855.859,2689.127;Inherit;False;Property;_CutAlphaSmooth;Cut Alpha Smooth;26;0;Create;True;0;0;False;1;MaxGay;False;0;1.423529;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;185;1263.857,2380.128;Inherit;False;Color Mask;-1;;48;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;218;-1834.583,-43.90005;Inherit;False;134;Mask_A_Red;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;88;-1838.207,-190.4908;Inherit;False;83;Color3;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;188;1759.86,2380.128;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;219;-1583.271,-126.9523;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;128;-1537.323,-35.37779;Inherit;False;81;Color1UV3;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;127;-1506.323,87.62218;Inherit;False;119;PaintSelection;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;1550.841,-863.9733;Inherit;False;Property;_PaintSmoothness;Paint Smoothness;21;0;Create;True;0;0;False;0;False;0;0.1573163;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;130;-113.1507,340.9817;Inherit;False;Property;_DirtBrightness;Dirt Brightness;18;0;Create;True;0;0;False;0;False;0;0.1173936;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;1079.862,-1104.907;Inherit;False;Property;_MainSmoothness;Main Smoothness;19;0;Create;True;0;0;False;0;False;0;0.1068977;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;215;-2469.783,1550.812;Inherit;False;Property;_BakedNMScale;Baked NM Scale;25;0;Create;True;0;0;False;0;False;1;1.100135;1;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;167;1941.254,-747.2681;Inherit;False;52;DirtSelection;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-2422.818,1861.233;Inherit;False;Property;_DetailsNMScale;Details NM Scale;11;0;Create;True;0;0;False;0;False;0;0.3822926;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;192;777.4351,1403.993;Inherit;False;189;AlphaSelection;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;1075.518,1906.409;Float;False;Property;_Displacement;Displacement;5;0;Create;True;0;0;False;0;False;0;0.159;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;217;-2152.783,1484.812;Inherit;True;Property;_DBK_Brick_Rubble_Tile_NM;DBK_Brick_Rubble_Tile_NM;24;0;Create;True;0;0;False;0;False;-1;7b511ab90838e7242a50fcf139971129;7b511ab90838e7242a50fcf139971129;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;21;-2085.818,1735.233;Inherit;True;Property;_DetailsNM;Details NM;10;0;Create;True;0;0;False;0;False;-1;4ea5083d09e1aa747b5ad9a32ad2cb74;4ea5083d09e1aa747b5ad9a32ad2cb74;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;172;1134.518,1624.409;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;948.9877,-185.9609;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;173;1381.518,1675.409;Inherit;False;4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;205;1591.792,1718.963;Inherit;False;Tessalation;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2775.297,272.2168;Float;False;True;-1;6;;0;0;Standard;DBK/CinderblockRubbleTile;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.4;True;True;0;False;TransparentCutout;;AlphaTest;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;True;0;20;10;40;True;1;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;28;-1;-1;0;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=42AAB2B0CFEEA8B39667FD205CFFBE17D5F1236B