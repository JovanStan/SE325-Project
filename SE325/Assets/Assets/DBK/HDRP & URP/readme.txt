If you want to use HDRP or LWRP rendering pipelines please install the correct package. It will replace all DBK materials and shaders. If you want switch back to Deferred/Forward render install Default.unitypackage
